...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    private static final String sections[] = {"My Posts", "Feed", "Buttons"};
    private static final int NUM_PAGER_SECTIONS = 3;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton cameraButton = (ImageButton) findViewById(R.id.camera_photo_button);
        ...
        public Fragment getItem(int i) {
            switch (i) {
                case 0:
                    ...
                    return new MyPostsSectionFragment();
                    //return new LaunchpadSectionFragment();
                case 1:
                    return new MyFeedSectionFragment();
                case 2:
                    return new MyButtonsSectionFragment();
                default:
...
//                    fragment.setArguments(args);
    ...
    public static class MyPostsSectionFragment extends Fragment {
...
//                            Intent intent = new Intent(getActivity(), ButtonViewActivity.class);
...
//                    });
    ...
    public static class MyFeedSectionFragment extends Fragment {
...
//                    });
    ...
    public static class MyButtonsSectionFragment extends Fragment {
...
//                .beginTransaction();
//        transaction.replace(R.layout.activity_main, cameraFragment);
